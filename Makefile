...
local-dev: make_activate_env
	...
	@sudo docker build -t project-code-api:develop . --no-cache
	@sudo docker run -p 8000:8000 project-code-api:develop
...
deploy-dev: make_activate_env
	...
	@sudo docker login machinacr.azurecr.us
	@sudo docker build -t project-code-api:develop . --no-cache
	@sudo docker tag project-code-api:develop machinacr.azurecr.us/project-code-api:develop
	@sudo docker push machinacr.azurecr.us/project-code-api:develop
